...
<?php
  ...
  $strQuery = "SELECT DISTINCT product,MaxOpenDays,MinOpenDays,AvgOpenDays FROM GraphData; ";
  ...
  if ($result) {
	...
	$arrData = array(
          ...
          // pushing category array values
        	while($row = mysqli_fetch_array($result)) {
				...
				array_push($dataseries1, array(
					"value" => $row["MaxOpenDays"]
					)
				);

				array_push($dataseries2, array(
					"value" => $row["MinOpenDays"]
					)
				);
        array_push($dataseries3, array(
					"value" => $row["AvgOpenDays"]
					)
				);
    	...
    	$arrData["categories"]=array(array("category"=>$categoryArray));
			...
			$arrData["dataset"] = array(array("seriesName"=> "MaxOpenDays","color"=> "#0c660d", "data"=>$dataseries1), array("seriesName"=> "MinOpenDays", "color"=> "#ed3902",  "renderAs"=>"line", "data"=>$dataseries2),array("seriesName"=> "AvgOpenDays", "color"=> "#000000", "renderAs"=>"area", "data"=>$dataseries3));
